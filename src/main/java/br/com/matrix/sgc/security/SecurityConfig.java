package br.com.matrix.sgc.security;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.authorizeRequests()
			...
			.antMatchers("/pedidos/**","/clientes/**","/contaspagar/**").hasAnyRole("VENDEDORES", "AUXILIARES", "ADMINISTRADORES")
			.antMatchers("/produtos/**","/clientes/**","/relatorios/**").hasRole("ADMINISTRADORES")
			.and()
